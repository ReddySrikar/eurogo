...
?>
<?php
				$sql = mysql_query("SELECT * FROM uk");
				...
				if($prod_count>0){
					...
					while($row=mysql_fetch_array($sql)){
						...
						$dynamic_list .= "<div class='col-md-4' ><a href='c_view.php?id=".$id."' class='iframe'>
						<div class='thumbnail'><img src='storeimages/uk/$imgid' alt='$dynamicTitle' />
