...
//echo "$userID <br /> $user <br /> $password";
$qry = mysql_query("SELECT * FROM users WHERE username='$username' AND password='$password'");//WHERE idn='$managerID' AND username='$manager' AND password1='$password1'
...
if($count==0){
	echo "<h1>111111Dear Hacker.<br />Your login SESSION data is incorrect.I'm calling the cops!!.WIggle Wiggle Wiggle.!!</h1>";
exit();
}
      ...
      $(document).ready(function () {
          ...
          $('#eumap').vectorMap({ map: 'europe_mill',
                    onRegionClick: function(event, code){
                        if (code == "IT") {window.location = 'grid1.php'}
                        if (code == "GB") {window.location = 'uk.php'}
...
<div class="col-md-12" style="background: url(background.jpg);background-size: 400px 200px;background-repeat:repeat;">
<div class="thumbnail col-md-offset-3 col-md-6 col-md-offset-3"> 
<div id="eumap" style="width: 100%; height: 400px; position:relative;">
</div>
